    ...
    <DraftSurface>
      ...
      >
        ...
        <text
          ...
          className={`fade-note ${DRAFT_TEXT_SOFT} opacity-60`}
        >
          ⌘C
        </text>
        <line
