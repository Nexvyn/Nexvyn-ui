...
const searchItems: SearchItem[] = [
    // Components
    { title: "Button", description: "A customizable button component", url: "/docs/components/button", type: "component" },
    { title: "Card", description: "A card container component", url: "/docs/components/card", type: "component" },
    { title: "Input", description: "An input field component", url: "/docs/components/input", type: "component" },
    // Getting Started
    { title: "Introduction", description: "Get started with Pixel Perfect UI", url: "/docs", type: "doc" },
    { title: "Installation", description: "How to install and set up", url: "/docs/getting-started/installation", type: "doc" },
    { title: "Quick Start", description: "Quick start guide", url: "/docs/getting-started/quick-start", type: "doc" },
    // Other
    { title: "Sponsors", description: "Our sponsors", url: "/docs/sponsors", type: "doc" },
]
                    ...
                    <div className="fixed left-1/2 top-1/4 -translate-x-1/2 w-full max-w-lg">
                        ...
                        >
                            ...
                            <Command.List className="max-h-80 overflow-y-auto p-2">
                                ...
                                {filteredItems.filter(i => i.type === "component").length > 0 && (
                                    <Command.Group heading="Components">
                                        <p className="px-2 py-1.5 text-xs font-medium text-muted-foreground">Components</p>
                                        {filteredItems
                                ...
                                {filteredItems.filter(i => i.type === "doc").length > 0 && (
                                    <Command.Group heading="Documentation">
                                        <p className="px-2 py-1.5 text-xs font-medium text-muted-foreground">Documentation</p>
                                        {filteredItems
