    ...
    <section className="pt-8 md:pt-12">
      <div className="dark:bg-secondary bg-secondary/30 relative mx-auto max-w-4xl rounded-2xl border p-10">
        <div className="mx-auto flex w-full max-w-5xl flex-col items-center justify-start text-center">
          <Logo />
          <h2 className="text-foreground leading-tighter mt-6 max-w-2xl font-sans text-4xl font-semibold tracking-tight text-balance lg:leading-[1.1] lg:font-semibold xl:tracking-tighter">
            Build faster. Convert better.
          </h2>
          <p className="text-muted-foreground mt-4 max-w-2xl text-base text-balance">
            Everything you need to create high-converting React & Next.js websites. Get access to
            our premium blocks and templates.
          </p>
          <Button
            asChild
            size="lg"
          ...
          >
            <Link href="https://ui.nexvyn.dev" target="_blank">
              Nexvyn UI <ExternalLink />
            </Link>
          </Button>
        </div>
      </div>
