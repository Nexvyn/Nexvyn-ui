...
export function Footer() {
  return (
    <footer
      className="max-w-6xl mx-auto w-full px-4 sm:px-6 md:px-12 py-2 flex items-center justify-between text-sm"
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <a
          ...
          className="inline-flex items-center justify-center h-11 w-11 rounded-md hover:bg-accent transition-colors"
