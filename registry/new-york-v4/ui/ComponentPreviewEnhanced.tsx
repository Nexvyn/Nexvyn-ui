...
interface ComponentPreviewEnhancedProps {
  ...
  code: string
  language?: string
  groupId?: string // For persistent shared state across multiple previews
}
...
export function ComponentPreviewEnhanced({
  preview,
  code,
  language = "tsx",
  groupId = "preview",
}: ComponentPreviewEnhancedProps) {
  ...
  return (
    <Tabs groupId={groupId} items={["Preview", "Code"]} className={styles.container} persist>
      <Tab value="Preview">
